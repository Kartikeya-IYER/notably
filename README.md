...
- API Client for testing: [Bruno](https://github.com/usebruno/bruno)
    - Another find made during the week that I started (and finished over the course of five days part-time) this project, Bruno is a completely and totally offline API testing client with a simple IDE.
